...
public class ReactiveKafkaConfigurationBA {
	...
	@Getter
	private KafkaReceiver<String, byte[]> consumer;
	@Getter
	private KafkaSender<String, byte[]> producer;

	public ReactiveKafkaConfigurationBA(ReactiveKafkaProperties reactiveKafkaProperties, String labelTopicName){
	...
	static class ConsumerConfiguration {
		...
		public KafkaReceiver<String, byte[]> builder(){
		...
		private ReceiverOptions<String, byte[]> kafkaReceiverOptions() {
			ReceiverOptions<String, byte[]> options = ReceiverOptions.create(kafkaConsumerConfiguration());
		...
		private KafkaReceiver<String, byte[]> reactiveKafkaReceiver() {
	...
	static class ProducerConfiguration {
		...
		public KafkaSender<String, byte[]> builder(){
		...
		private SenderOptions<String, byte[]> kafkaSenderOptions() {
			SenderOptions<String, byte[]> options = SenderOptions.create(kafkaProducerConfiguration());
			return options;
		}

		private KafkaSender<String, byte[]> reactiveKafkaSender() {
